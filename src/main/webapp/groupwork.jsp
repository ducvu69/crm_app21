...
<body>
                                    ...
                                    <c:forEach var="item" items="${listJob}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span jobid="${item.getId()}" class="btn btn-sm btn-danger btn-delete-job">Xóa</span>
                                                <%-- <a href="<c:url value="/job/delete?id=${item.getId()}"/>" class="btn btn-sm btn-danger">Xóa</a> --%>
    ...
    <script src="<c:url value="/js/job-table.js?version=1"/>"></script>
    <script>
