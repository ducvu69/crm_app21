...
<body>
                                    ...
                                    <c:forEach var="item" items="${listUsers}">
                                        <tr>
                                            ...
                                            <td>
                                              ...
                                              <%-- Sử dụng id, name, class để định danh cho thẻ --%>
                                              <%-- Trường hợp này vì id là duy nhất nên vòng lặp for duyệt thấy id đầu tiên là sẽ dừng lại --%>
    ...
    <!-- Khai báo đường dẫn file user-table.js vào page jsp để sử dụng -->
    <!-- Thêm ?version=1 để clear cache trong javascript -->
